...
export const metadata: Metadata = {
  metadataBase: new URL("https://opensrc.dev"),
  title: {
    default: "opensrc | Source Code for AI Coding Agents",
    template: "%s | opensrc",
  },
  description:
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://opensrc.dev",
    siteName: "opensrc",
    title: "opensrc | Source Code for AI Coding Agents",
    description:
      "Fetch source code for packages to give coding agents deeper context.",
    images: [{ url: "/og", width: 1200, height: 630, alt: "opensrc" }],
  },
  twitter: {
